...
import 'package:portfolio/animationCallback.dart';
...
class HoverCard extends StatefulWidget {
  ...
  final Animation<FractionalOffset> animation;
...
class HoverCardState extends State<HoverCard>
  ...
  void _resetAnimation(Size size, Offset offset) {
    ...
    widget.animationCallback(FractionalOffsetTween(
  ...
  void _updatePosition() {
    setState(() {
      localX = widget.animation.value.dx;
      localY = widget.animation.value.dy;
    });
  }
